...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <strong>Português</strong> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.panai.local" target="_blank">Site oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidade:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-9.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/PanAI" target="_blank">Twitter</a>
</p>
...
[🤔 Por que escolher PanAI?](#-por-que-escolher-panai-sobre-claude-cowork) ·
...
PanAI vem com um motor de Agent AI completo. Diferente de ferramentas que exigem instalar CLI Agents separadamente, **PanAI funciona no momento em que você o instala**.
...
Outros apps de AI te dão uma caixa de chat com sua chave API. **PanAI te dá um Cowork Agent completo.**
...
PanAI também suporta o serviço de gateway [NewAPI](https://github.com/QuantumNous/new-api) — um hub unificado de modelos AI que agrega e distribui vários LLMs. Alterne flexivelmente entre diferentes modelos na mesma interface para atender a vários requisitos de tarefas.
...
- **Habilidades de três camadas** — Habilidades integradas (incluídas com o PanAI), habilidades personalizadas (suas próprias) e habilidades de Extension (contribuídas por extensões de terceiros); habilite/desabilite por conversa com o indicador de habilidades
...
PanAI inclui **21 assistentes profissionais** com capacidades predefinidas, extensíveis através de habilidades personalizadas:
...
_Seu assistente AI 24/7 — acesse PanAI de qualquer dispositivo, em qualquer lugar._
...
> [Tutorial de acesso remoto à Internet](https://github.com/ActiveInAI/PanAI/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Evitar suspensão** — O PanAI previne automaticamente a suspensão do sistema enquanto as tarefas estão ativas e detecta acionamentos perdidos após o despertar
...
> [Guia de configuração do modelo de geração de imagens](https://github.com/ActiveInAI/PanAI/wiki/PanAI-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Por que escolher PanAI sobre Claude Cowork?
...
R: <strong>Não.</strong> PanAI tem um AI Agent integrado que funciona imediatamente após a instalação. Basta fazer login com Google ou inserir qualquer chave API. Se você também tiver ferramentas CLI como Claude Code ou Gemini CLI instaladas, PanAI as detectará e integrará automaticamente para ainda mais capacidades.
</details>

<details>
<summary><strong>P: O que posso fazer com PanAI?</strong></summary>
R: PanAI é seu <strong>espaço de trabalho Cowork privado</strong>. O Agent integrado pode organizar pastas em lote, processar dados do Excel, gerar documentos, buscar na web e gerar imagens. Com o Modo Multi-Agent, você também pode aproveitar Claude Code, Codex e outros Agents CLI poderosos através da mesma interface.
</details>

<details>
<summary><strong>P: É gratuito?</strong></summary>
R: PanAI é completamente gratuito e de código aberto. Você pode fazer login com Google para usar Gemini gratuitamente, ou usar chaves API de qualquer provedor que preferir.
</details>
...
## Veja como as pessoas usam PanAI
...
> **Fez um vídeo sobre PanAI?** [Avise-nos no X](https://x.com/PanAI) e vamos destacá-lo aqui!
...
- [📖 Guia de instalação completo](https://github.com/ActiveInAI/PanAI/wiki/Getting-Started) — Passos detalhados do download à configuração
- [⚙️ Guia de configuração LLM](https://github.com/ActiveInAI/PanAI/wiki/LLM-Configuration) — Configuração de modelos AI multiplataforma
- [🤖 Configuração do modo Multi-Agent](https://github.com/ActiveInAI/PanAI/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuração de ferramentas MCP](https://github.com/ActiveInAI/PanAI/wiki/MCP-Configuration-Guide) — Configuração do servidor Model Context Protocol
- [🌐 Guia de configuração WebUI](https://github.com/ActiveInAI/PanAI/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuração e instalação do WebUI

**🎯 Casos de uso**

- [📁 Gerenciamento de arquivos](https://github.com/ActiveInAI/PanAI/wiki/file-management) — Organização inteligente de arquivos
- [📊 Processamento de Excel](https://github.com/ActiveInAI/PanAI/wiki/excel-processing) — Processamento de dados alimentado por AI
- [🎨 Geração de imagens](https://github.com/ActiveInAI/PanAI/wiki/PanAI-Image-Generation-Tool-Model-Configuration-Guide) — Criação de imagens AI
- [📚 Mais casos de uso](https://github.com/ActiveInAI/PanAI/wiki/Use-Cases-Overview)

**❓ Suporte e ajuda**

- [❓ FAQ](https://github.com/ActiveInAI/PanAI/wiki/FAQ) — Perguntas e solução de problemas
- [🔧 Tutoriais de configuração e uso](https://github.com/ActiveInAI/PanAI/wiki/Configuration-Guides) — Documentação de configuração completa
...
- [GitHub Discussions](https://github.com/ActiveInAI/PanAI/discussions) — compartilhe ideias e troque dicas
- [Reportar problemas](https://github.com/ActiveInAI/PanAI/issues) — bugs e solicitações de recursos
- [Atualizações de lançamento](https://github.com/ActiveInAI/PanAI/releases) — obtenha a última versão
...
[Reportar bug](https://github.com/ActiveInAI/PanAI/issues) · [Solicitar recurso](https://github.com/ActiveInAI/PanAI/issues)
