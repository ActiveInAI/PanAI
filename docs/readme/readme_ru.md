...
[🤔 Почему PanAI?](#-why-choose-panai-over-claude-cowork) ·
...
**PanAI — это больше, чем просто клиент для чата.** Это платформа Cowork, где ИИ-агенты работают вместе с вами на вашем компьютере — читают файлы, пишут код, просматривают веб-страницы и автоматизируют задачи. Вы видите всё, что делает агент, и всегда остаётесь в управлении.

|                                        | Традиционные ИИ-чаты | **PanAI (Cowork)**                                                                                                       |
| :------------------------------------- | :------------------- | :----------------------------------------------------------------------------------------------------------------------- |
...
PanAI поставляется с полноценным движком ИИ-агента. В отличие от инструментов, требующих отдельной установки CLI-агентов, **PanAI работает сразу после установки**.
...
Если вы уже используете Claude Code, Codex, Hermes Agent или OpenClaw, PanAI автоматически обнаружит их и позволит работать со всеми ними вместе со встроенным агентом.

**Поддерживаемые агенты:** Встроенный агент (без настройки) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Pan CLI • Snow CLI • Hermes Agent • Cursor Agent и другие
...
- **Параллельное выполнение нескольких агентов** — Leader разбивает задачи на подзадачи и делегирует параллельно работающим Teammate-агентам; каждый Teammate использует свою модель через ACP (Agent Communication Protocol, слой координации мультиагентности PanAI), Gemini или PanCli
- **Оркестрация Leader** — Leader назначает, отслеживает и агрегирует результаты; поддерживаемые бэкенды: Claude Code, Codex, Hermes Agent, Gemini, Snow CLI, Pan CLI
...
- **Поддерживаемые бэкенды** — Claude Code, Codex, Gemini, Snow CLI, Pan CLI; другие ACP-бэкенды с `mcpCapabilities.stdio` поддерживаются автоматически
...
Другие ИИ-приложения дают вам чат с вашим API-ключом. **PanAI даёт полноценного Cowork-агента.**
...
Одни и те же возможности — чтение/запись файлов, поиск в интернете, генерация изображений, использование инструментов — независимо от того, какая модель лежит в основе. PanAI поддерживает **30+ ИИ-платформ**, включая облачные сервисы и локальные развёртывания.
...
PanAI также поддерживает шлюз-сервис [NewAPI](https://github.com/QuantumNous/new-api) — единый хаб ИИ-моделей, агрегирующий и распространяющий различные LLM. Гибкое переключение между разными моделями в одном интерфейсе для решения различных задач.
...
- **Трёхуровневые навыки** — встроенные навыки (поставляются с PanAI), пользовательские навыки (ваши собственные) и Extension-навыки (от сторонних расширений); включайте/отключайте для каждого разговора с помощью индикатора навыков
...
PanAI включает **21 профессиональный ассистент** с предопределёнными возможностями, расширяемыми через пользовательские навыки:
...
**Пользовательские навыки**: создавайте навыки в директории `skills/`, включайте/отключайте навыки для ассистентов, расширяя возможности ИИ. Навыки поступают из трёх источников: встроенные (поставляются с PanAI), пользовательские (ваши собственные) и Extension (через Extension SDK). Встроенные навыки включают `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` и другие.
...
_Ваш ИИ-ассистент 24/7 — доступ к PanAI с любого устройства, из любой точки мира._
...
> **Настройка:** Настройки PanAI → Настройки WebUI → Канал, настройте токен бота.
...
> [Руководство по удалённому доступу через интернет](https://github.com/ActiveInAI/PanAI/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Режим без сна** — PanAI автоматически предотвращает переход системы в спящий режим, пока активны задачи, и определяет пропущенные триггеры после пробуждения
...
> [Руководство по конфигурации модели генерации изображений](https://github.com/ActiveInAI/PanAI/wiki/PanAI-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Почему PanAI вместо Claude Cowork?
...
PanAI — это **бесплатный мультиагентный рабочий стол с открытым исходным кодом**. По сравнению с Claude Cowork, который работает только на macOS и привязан к Claude, PanAI — его кроссплатформенная улучшенная версия со всеми моделями.

| Параметр          | Claude Cowork  | PanAI                                                        |
| :---------------- | :------------- | :----------------------------------------------------------- |
...
## Посмотрите, как люди используют PanAI
...
> **Сняли видео об PanAI?** [Сообщите нам в X](https://x.com/PanAI), и мы разместим его здесь!
...
- [📖 Полное руководство по установке](https://github.com/ActiveInAI/PanAI/wiki/Getting-Started) — подробные шаги от загрузки до настройки
- [⚙️ Руководство по настройке LLM](https://github.com/ActiveInAI/PanAI/wiki/LLM-Configuration) — настройка ИИ-моделей на множестве платформ
- [🤖 Настройка мультиагентного режима](https://github.com/ActiveInAI/PanAI/wiki/ACP-Setup) — интеграция ИИ-агентов терминала
- [🔌 Настройка MCP-инструментов](https://github.com/ActiveInAI/PanAI/wiki/MCP-Configuration-Guide) — настройка сервера Model Context Protocol
- [🌐 Руководство по настройке WebUI](https://github.com/ActiveInAI/PanAI/wiki/WebUI-Configuration-Guide) — полное руководство по настройке WebUI

**🎯 Сценарии использования**

- [📁 Управление файлами](https://github.com/ActiveInAI/PanAI/wiki/file-management) — умная организация файлов
- [📊 Обработка Excel](https://github.com/ActiveInAI/PanAI/wiki/excel-processing) — обработка данных на базе ИИ
- [🎨 Генерация изображений](https://github.com/ActiveInAI/PanAI/wiki/PanAI-Image-Generation-Tool-Model-Configuration-Guide) — создание изображений на базе ИИ
- [📚 Больше сценариев](https://github.com/ActiveInAI/PanAI/wiki/Use-Cases-Overview)

**❓ Поддержка и помощь**

- [❓ FAQ](https://github.com/ActiveInAI/PanAI/wiki/FAQ) — вопросы и устранение неполадок
- [🔧 Руководства по настройке и использованию](https://github.com/ActiveInAI/PanAI/wiki/Configuration-Guides) — полная документация по настройке
...
- [GitHub Discussions](https://github.com/ActiveInAI/PanAI/discussions) — делитесь идеями и обменивайтесь советами
- [Сообщить о проблемах](https://github.com/ActiveInAI/PanAI/issues) — ошибки и запросы функций
- [Обновления релизов](https://github.com/ActiveInAI/PanAI/releases) — получите последнюю версию
...
[Сообщить об ошибке](https://github.com/ActiveInAI/PanAI/issues) · [Запросить функцию](https://github.com/ActiveInAI/PanAI/issues)
