...
**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Pan CLI (aionrs, Rust-бекенд-сервіс, що постачається з PanAI) • Snow CLI • Hermes Agent • Cursor Agent та інші
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності PanAI), Gemini або Aionrs
...
- **Підтримувані бекенди** — Claude Code, Codex, Gemini, Snow CLI, Pan CLI (aionrs); інші ACP-бекенди з `mcpCapabilities.stdio` підтримуються автоматично
...
<p align="center">
  <img src="../../resources/panai-sort-file-2.gif" alt="Керування файлами" width="800">
</p>
