<p align="center">
  <img src="../../resources/panai-banner-1.svg" alt="PanAI - Спільна робота з AI-агентами" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/ActiveInAI/PanAI?style=flat-square&color=32CD32" alt="Версія">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <strong>Українська</strong> | <a href="https://www.panai.local" target="_blank">Офіційний сайт</a>
</p>

<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-9.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/PanAI" target="_blank">Twitter</a>
</p>
...
[🤔 Чому варто обрати PanAI?](#-чому-варто-обрати-panai-замість-claude-cowork) ·
...
**PanAI — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **PanAI (Cowork)**                                                                                                   |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------- |
...
PanAI постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **PanAI працює одразу після встановлення**.
...
<p align="center">
  <img src="../../resources/panai-feature-agent.svg" alt="Вбудовані агенти" width="800">
</p>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="../../resources/panai-feature-office.svg" alt="Morph PPT — переходи між слайдами (OfficeCLI)" width="390">
    </td>
    <td align="center" width="50%">
      <img src="../../resources/panai-feature-office.svg" alt="Асистент PPT — запис екрану" width="390">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="../../resources/panai-feature-research.svg" alt="Демо генерації наукової статті" width="390">
    </td>
    <td align="center" width="50%">
      <img src="../../resources/panai-feature-research.svg" alt="Демо асистента для написання статей" width="390">
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="../../resources/panai-feature-office.svg" alt="Демо генерації Excel" width="390">
    </td>
    <td align="center" width="50%">
      <img src="../../resources/panai-feature-office.svg" alt="Демо асистента Excel" width="390">
    </td>
  </tr>
</table>
...
Якщо ви вже використовуєте Claude Code, Codex, Hermes Agent або OpenClaw, PanAI автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.

**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Pan CLI • Snow CLI • Hermes Agent • Cursor Agent та інші

<p align="center">
  <img src="../../resources/panai-feature-multiagent.svg" alt="Мульти-агентний режим" width="800">
</p>
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності PanAI), Gemini або PanCli
- **Оркестрація Leader** — Leader призначає, відстежує та агрегує результати; підтримувані бекенди: Claude Code, Codex, Hermes Agent, Gemini, Snow CLI, Pan CLI
...
- **Підтримувані бекенди** — Claude Code, Codex, Gemini, Snow CLI, Pan CLI; інші ACP-бекенди з `mcpCapabilities.stdio` підтримуються автоматично
...
Інші додатки дають лише вікно чату. **PanAI дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. PanAI підтримує **30+ AI-платформ**.

<p align="center">
  <img src="../../resources/panai-feature-models.svg" alt="Підтримка багатьох моделей" width="800">
</p>
...
- **Трирівневі навички** — вбудовані навички (поставляються з PanAI), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
- **Контроль для кожної розмови** — індикатор навичок у заголовку чату показує активні навички поточної розмови

<p align="center">
  <img src="../../resources/panai-feature-skills.svg" alt="Екосистема асистентів та навичок" width="800">
</p>
...
**Навички**: навички з трьох джерел — вбудовані (поставляються з PanAI), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
<p align="center">
  <img src="../../resources/panai-feature-remote.svg" alt="Демо віддаленого доступу WebUI" width="800">
</p>
...
<p align="center">
  <img src="../../resources/panai-feature-scheduled.svg" alt="Завдання за розкладом" width="800">
</p>
...
- **Режим без сну** — PanAI автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
<p align="center">
  <img src="../../resources/panai-feature-preview.svg" alt="Панель попереднього перегляду" width="800">
</p>
...
<p align="center">
  <img src="../../resources/panai-feature-files.svg" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати PanAI замість Claude Cowork?

PanAI — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, PanAI — це версія з підтримкою всіх моделей та платформ.
...
- [GitHub Discussions](https://github.com/ActiveInAI/PanAI/discussions) — діліться ідеями
- [Повідомити про проблему](https://github.com/ActiveInAI/PanAI/issues) — баги та запити функцій
...
Технологічний стек: Tauri · Vite · React · Rust · Bun
