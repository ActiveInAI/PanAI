...
PanAI is a multi-process Electron app with three core layers: **renderer**, **main process**, and **preload/shared**.
...
├── base/           # UI primitives — PanModal, PanSelect, FlexFullContainer, etc.
