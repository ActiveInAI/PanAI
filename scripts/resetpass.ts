 ...
 *   PANAI_DATA_DIR=/x bun run resetpass
...
import { startBackend, stopBackend } from '@panai/web-host';
 ...
 * desktop side). Callers can override with `--port` / `PANAI_PORT` to match
 ...
 * pass --port / PANAI_PORT if they launched webui on a non-default one.
 */
