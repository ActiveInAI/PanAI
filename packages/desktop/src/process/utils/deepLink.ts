...
export const PROTOCOL_SCHEME = 'panai';

/**
 * Parse a panai:// URL into action and params.
 * Supports two formats:
 *   1. panai://add-provider?base_url=xxx&api_key=xxx
 *   2. panai://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
