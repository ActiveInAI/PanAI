export const WORKSPACE_TOGGLE_EVENT = 'panai-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'panai-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'panai-workspace-has-files';
