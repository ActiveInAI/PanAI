 ...
 * <PanScrollArea className="h-400px">
 *   <div>Content...</div>
 * </PanScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <PanScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </PanScrollArea>
 *
 * // 双向滚动 / Both directions
 * <PanScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </PanScrollArea>
 * ```
 */
interface PanScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const PanScrollArea: React.FC<PanScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
PanScrollArea.displayName = 'PanScrollArea';

export default PanScrollArea;
