...
type PanSelectSize = NativeSelectSize | 'middle';

export interface PanSelectProps extends NativeSelectProps {
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <PanSelect placeholder="请选择" style={{ width: 200 }}>
 *   <PanSelect.Option value="1">选项1</PanSelect.Option>
 *   <PanSelect.Option value="2">选项2</PanSelect.Option>
 * </PanSelect>
 *
 * // 多选 / Multiple selection
 * <PanSelect mode="multiple" placeholder="请选择多个">
 *   <PanSelect.Option value="1">选项1</PanSelect.Option>
 *   <PanSelect.Option value="2">选项2</PanSelect.Option>
 * </PanSelect>
 *
 * // 分组 / Grouped options
 * <PanSelect placeholder="请选择">
 *   <PanSelect.OptGroup label="分组1">
 *     <PanSelect.Option value="1">选项1</PanSelect.Option>
 *   </PanSelect.OptGroup>
 *   <PanSelect.OptGroup label="分组2">
 *     <PanSelect.Option value="2">选项2</PanSelect.Option>
 *   </PanSelect.OptGroup>
 * </PanSelect>
 * ```
 ...
 */
const mapSizeToNative = (size?: PanSelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type PanSelectComponent = React.ForwardRefExoticComponent<PanSelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, PanSelectProps>(
...
const PanSelect = InternalSelect as PanSelectComponent;

PanSelect.displayName = 'PanSelect';

// 导出子组件 / Export sub-components
PanSelect.Option = Select.Option;
PanSelect.OptGroup = Select.OptGroup;
