            ...
            >
              ...
              >
                <button
                  type='button'
                  className={classNames(
                    'shrink-0 size-32px relative rd-0.5rem flex items-center justify-center overflow-visible bg-transparent border-none p-0 cursor-pointer',
                    {
                      '!size-24px': collapsed,
                    }
                  )}
                ...
                >
                  <img
                    src={panAILogoUrl}
                    alt=''
                    className={classNames('block w-31px h-31px object-contain', {
